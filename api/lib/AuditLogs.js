...
class AuditLogs {
    ...
    #saveToDB({level, email, location, proc_type, log}){    // # sadece bu clastan erişim var private
...
module.exports = new AuditLogs; // new ile her importta new kullanmamış oluruz zaten singlton